...
public class GMailer {
    ...
    private static final String TEST_EMAIL = "<nour.louhaichi@esprit.tn>";
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(
                jsonFactory,
                new InputStreamReader(GMailer.class.getResourceAsStream("/client_secret_434198879934-3jvci2bbra5h7u8afth06v5g9i8bd377.apps.googleusercontent.com.json"))
        );
